  ...
  products: [
    {
      ...
      BUP_Value: "",
      badges:
        "https://cdn.zamro.com/assets/10_/adi-free-icon-nl.jpg|https://cdn.zamro.com/assets/db_/reach-icon-nl.jpg|https://cdn.zamro.com/assets/ba_/rohs-icon-nl.jpg|https://cdn.zamro.com/assets/88_/fda-icon-nl.jpg|https://cdn.zamro.com/assets/35_/eu-1935-2004-icon-nl.jpg",
      uom: "Stuk",
      Kleur: "Zwart",
...
const notCompared = ['salePrice', 'manufacturerName', 'grossPrice', 'BUP_UOM', 'BUP_Value', 'uom', 'productImage',
    'BUP_Conversion', 'minQuantity', 'manufacturerImage', 'name', 'sku', 'listPrice', 'channel', 'display', 'atp']
export  {data, notCompared}